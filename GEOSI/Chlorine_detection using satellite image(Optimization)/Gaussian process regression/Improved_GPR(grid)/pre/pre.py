...
gp_model = joblib.load('Improved_GP_Model.pkl')
...
results.to_excel('Improved_Full_Dataset_Predictions.xlsx', index=False)
...
plt.title('Actual vs Predicted (Improved Full Dataset)')
plt.legend()
plt.grid()

# Save and show the plot
plt.tight_layout()
plt.savefig('Improved_Full_Dataset_Scatter_Identity.png')
plt.show()
